...
def plot_with_one_axis(list_of_data:list, name_x="x", name_y="y", plot_title="", filename_to_save="nosvg", marker_size="5", font_size=16, offset_text_size=16, legend_local="best", legend_size=16, x_ticks_limit=5, x_ticks_numstyle="sci", line_width=1.5, y_lim = None): # [data_x, data_y, label, colorr, line_style, marker_type]
    ...
    plt.gca().yaxis.get_offset_text().set_fontsize(offset_text_size)
...
def plot_with_one_axis_with_vertical_lines(list_of_data:list, name_x="x", name_y="y", plot_title="title", filename_to_save="nosvg", marker_size="5", font_size=16, offset_text_size=16, legend_local="best", legend_size=16, x_ticks_limit=5, vlines=None, y_lim = None): # [data_x, data_y, label, colorr, line_style, marker_type], [[x_val, color, linestyle], ...]
    ...
    Args:
        ...
        x_ticks_limit (int): Number of ticks on x-axis.
        y_lim (list): example: y_lim = [0, 250]
        v_lines (list): example: v_lines = [[x_val, color, linestyle]]
    """
...
def one_axis__N_Y_with_error_bars__with_N_fits(list_of_data: list, list_of_fit: list, name_x="name_x", name_y="name_y", plot_title="title", filename_to_save="nopdf", marker_type="o", marker_size="5", capsize_errorbars=5, alpha_data=0.5, font_size=16, offset_text_size=16, legend_size=16, legend_local="best", x_ticks_limit=5): # [x,y,y_err,label,color,linestyle]                                               
    ...
    # [x,y,y_err,label,color,linestyle]
...
def one_axis__N_Y_with_error_bars(list_of_data: list, name_x="name_x", name_y="name_y", plot_title="title", filename_to_save="nopdf", marker_type="o", marker_size="5", capsize_errorbars=5, alpha_data=0.5, font_size=16, offset_text_size=16, legend_size=16, legend_local="best", x_ticks_limit=5, x_ticks_numstyle="sci", ignore_tick_label=False): # [x,y,y_err,label,color,linestyle]   
